...
dag = DAG('cron_hdfs_uploader_clickstream_hits',
...
command = 'sudo env PATH=$PATH su -c "{acumen_cron_scripts_dir}/cron-hdfs-uploader-clickstream-hits.sh" {user}'.format(acumen_cron_scripts_dir=task_config['acumen_cron_scripts_dir'], user=task_config['user'])

t1 = BashOperator(task_id='cron_hdfs_uploader_clickstream_hits',

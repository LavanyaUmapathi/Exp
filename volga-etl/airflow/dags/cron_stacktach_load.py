...
command = 'sudo env PATH=$PATH su -c "{acumen_cron_scripts_dir}/cron-stacktach-load.sh" {user}'.format(acumen_cron_scripts_dir=task_config['acumen_cron_scripts_dir'], user=task_config['user'])

t1 = BashOperator(task_id='cron_stacktach_load',

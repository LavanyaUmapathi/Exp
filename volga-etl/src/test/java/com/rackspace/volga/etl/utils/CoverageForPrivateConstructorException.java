...
public class CoverageForPrivateConstructorException extends RuntimeException {
     ...
     */
    protected static final String DEFAULT_MESSAGE = "Error while giving coverage to the private constructor of a " +
            "class.";
     ...
     */
    public CoverageForPrivateConstructorException(final Throwable cause) {

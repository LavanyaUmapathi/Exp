...
public class StackTachJSONDriverTest {

    StackTachJSONDriver driver;
    ...
    public void setUp() throws Exception {
        ...
        driver = PowerMockito.spy(new StackTachJSONDriver());
    ...
    public void whenRunningStackTachDriver() throws Exception {
        ...
        Assert.assertEquals(SystemEvent.class.getCanonicalName(), driver.getConf().get(ETLConstants
                .DTO_CLASS_KEY, SystemEvent.class.getCanonicalName()));
    }

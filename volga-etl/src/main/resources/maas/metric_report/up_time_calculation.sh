...
export SCRIPT_DIR=/home/maas/metric_report
...
echo $sqoopcmd
$dry eval $sqoopcmd
suppressioncmd="spark-submit --master yarn  $SCRIPT_DIR/device_status_to_suppression.py"
echo $suppressioncmd
$dry eval $suppressioncmd
#servicedowntimecmd="spark-submit --master yarn service_downtime.py"
servicedowntimecmd="spark-submit --master yarn  $SCRIPT_DIR/service_availability.py"
echo $servicedowntimecmd
$dry eval $servicedowntimecmd
mdowntimecmd="spark-submit --master yarn  $SCRIPT_DIR/monitor_availability.py"
echo $mdowntimecmd

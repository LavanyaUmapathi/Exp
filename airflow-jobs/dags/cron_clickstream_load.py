...
command = 'sudo env PATH=$PATH su -c "{acumen_cron_scripts_dir}/cron-clickstream-load.sh" {user}'.format(acumen_cron_scripts_dir=task_config['acumen_cron_scripts_dir'], user=task_config['user'])

t1 = BashOperator(task_id='cron_clickstream_load',
